...
（曾经计划把演员挪到 9224 与你分家，那版没有落地：Chrome 从 v127 起拒绝把调试端口作用于自己的默认 profile，只能用隔离拷贝，而隔离拷贝里没有登录态——实测那份 641MB 的拷贝在 x.com / google.com / reddit 三站全是游客态。于是演员留在 9222，白名单也只有 9222 / 9223 两个数。2026-09-15 起演员与机位改用 CfT，不再是 Edge，原因见 `frago book desktop-usage`。）
