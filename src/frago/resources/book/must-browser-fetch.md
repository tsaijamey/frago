...
## 怎么用
  {{frago_launcher}} browser navigate "https://example.com/page"
  {{frago_launcher}} browser get-content                           # 获取整页内容
  {{frago_launcher}} browser get-content --selector ".article"     # 获取指定区域
